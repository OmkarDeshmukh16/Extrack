...
function Dashboard() {
  ...
  return (
    <div className="p-8 bg-white dark:bg-[#121212] min-h-screen transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-6 gap-5">
        ...
        <div className="grid gap-5">
          <h2 className="font-bold text-lg text-gray-800 dark:text-gray-200">Latest Budgets</h2>
          {budgetList?.length > 0
